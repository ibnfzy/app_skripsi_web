...
class PengajuanJudul extends BaseController
{
    ...
    public function index(): string
    {
        ...
        $data = [
            ...
            'basePath' => '/Dekan/pengajuan-judul',
    ...
    public function show(int $id)
    {
        ...
        if ($submission === null) {
            ...
            return redirect()->to('/Dekan/pengajuan-judul');
        }
        ...
        $data = [
            ...
            'statusOptions' => ['Menunggu Review', 'Disetujui', 'Perlu Revisi', 'Ditolak'],
            'formAction' => "/Dekan/pengajuan-judul/{$id}/review",
            'basePath' => '/Dekan/pengajuan-judul',
            'flash' => session()->getFlashdata('success') ?? null,
            'error' => session()->getFlashdata('error') ?? null,
        ];
    ...
    public function review(int $id)
    {
        if ($this->request->getMethod() !== 'post') {
            return redirect()->to("/Dekan/pengajuan-judul/{$id}");
        }
